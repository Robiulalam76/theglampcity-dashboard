...
const MessageSendBox = ({ sendMessage }) => {
    ...
    const { receiverData, chatId } = useContext(MessageContext)
        ...
        <div class="p-4">
            ...
            <div class="flex items-center gap-1 w-full bg-gray-200 rounded-md">
                ...
                <button onClick={() => sendMessage(messageText)}
                    ...
                    className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-primary hover:bg-darkPrimary focus:outline-none">
