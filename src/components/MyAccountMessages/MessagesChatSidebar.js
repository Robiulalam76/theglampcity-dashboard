...
import MyAccountMessageSidbarDrawer from '../drawer/MyAccountMessageSidbarDrawer';

const MessagesChatSidebar = ({ chatData }) => {

    return (
        <div className='max-w-[300px] bg-white h-screen hidden lg:block'>
            <div className="">
                ...
                <ul className="overflow-auto h-[32rem] w-full">
