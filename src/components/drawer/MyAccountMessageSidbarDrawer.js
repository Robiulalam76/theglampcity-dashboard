...
const MyAccountMessageSidbarDrawer = () => {
    const { user } = useContext(AdminContext)
    const { openMyAccountMessageSidebar, setOpenMyAccountMessageSidebar } = useContext(MessageContext)
    ...
    return (
        <Drawer
            open={openMyAccountMessageSidebar}
            onClose={() => setOpenMyAccountMessageSidebar(false)}
            parent={null}
            level={null}
            placement={'left'}
        >
...
export default MyAccountMessageSidbarDrawer;